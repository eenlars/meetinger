    ...
    <div className="max-w-xl mx-auto mt-10">
      <Card>
        ...
        <CardContent className="text-sm text-muted-foreground/90 leading-normal prose">
          ...
          <p className="mb-3">
            Built with Next.js, AI SDK, Tailwind, Typescript and shadcn you can build a bare minimum AI Chatbot with only an
            environment variable. Based off the popular <Link href="https://chat.vercel.ai/">Next AI Chatbot</Link> the aim for
            this project is to remove any dependency outside of basic functionality and examples with an emphasis on making
            changes and experimenting with the AI SDK.{' '}
          </p>
          ...
          <p>
            <Link href="https://github.com/mattjared/nextjs-ai-lite" className="underline">
